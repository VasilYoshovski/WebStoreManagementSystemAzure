...
{
    [TestClass]
    public class CreatePost_Should:OfferConrollerMocks
    {

        [TestMethod]
        public async Task ReturnProper_WhenValidOfferModelIsPassed()
        {
            ...
            OfferService.Verify(mock => mock.CreateOfferAsync(1,10,new DateTime(2019,5,5),1,1,1), Times.Once());
        ...
        [TestMethod]
        public async Task ReturnResutViewWithProperModel_WhenValidOfferModelIsPassed()
        {
            var sale = new OfferCUViewModel
            {
                ClientID = 1,
