            ...
            using (var seedContext = new StoreSystemDbContext(options))
            {
                ...
                seedContext.Offers.Add(
                    new Offer
                    {
                        ...
                        ProductsInOffer = new List<ProductOffer>
                        {
                            new ProductOffer{ProductID = 3, Quantity =1 },
                        }
                    }
                );
                ...
                seedContext.Offers.Add(
                    new Offer
                    {
                        ...
                        CountryID = 2,
                        ProductDiscount = 0.1m,
                        ExpiredDate = new DateTime(2019, 3, 3),
                        DeliveryDate = new DateTime(2019, 3, 3),
                        OfferDate = new DateTime(2019, 3, 3),
                    }
                    );
                seedContext.Offers.Add(
                    new Offer
                    {
                        ...
                        CountryID = 2,
                        ProductDiscount = 0.1m,
                        ExpiredDate = new DateTime(2019, 4, 4),
                        DeliveryDate = new DateTime(2019, 4, 4),
                        OfferDate = new DateTime(2019, 4, 4),
                        ProductsInOffer = new List<ProductOffer>
                        {
                            new ProductOffer{ProductID = 1, Quantity =1 },
                            new ProductOffer{ProductID = 3, Quantity =1 }
